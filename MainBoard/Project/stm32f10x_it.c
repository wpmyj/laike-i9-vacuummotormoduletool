...
void TIM2_IRQHandler(void)        //1ms interrupt
{
	if(TIM_GetITStatus(TIM2,TIM_IT_Update)!=RESET)
	{
		...
		//吸尘波形
		if(mMaininf.mWork.mWorkVacuumPWMSendFlag == 1)
		{
			mMaininf.mWork.mWorkVacuumPWMSendCont ++;
			if(mMaininf.mWork.mWorkVacuumPWMSendCont == 5)
			{
				PAout(0) = ~PAout(0);
			}
			else if(mMaininf.mWork.mWorkVacuumPWMSendCont >= 10)
			{
				PAout(0) = ~PAout(0);
				mMaininf.mWork.mWorkVacuumPWMSendCont = 0;
			}
		}
	}
...
// 		{
// 			mMaininf.mWork.mWorkVacuumPWMSendCont ++;
// 			if(mMaininf.mWork.mWorkVacuumPWMSendCont == 10)
// 			{
// 				//PAout(0) = ~PAout(0);
// 				PAout(0) = 0;
// 			}
// 			else if(mMaininf.mWork.mWorkVacuumPWMSendCont >= 20)
// 			{
// 				//PAout(0) = ~PAout(0);
// 				PAout(0) = 1;
// 				mMaininf.mWork.mWorkVacuumPWMSendCont = 0;
// 			}
// 		}
// 		else if(mMaininf.mWork.mWorkVacuumPWMSendFlag == 2)
// 		{
// 			mMaininf.mWork.mWorkVacuumPWMSendCont ++;
// 			if(mMaininf.mWork.mWorkVacuumPWMSendCont == 15)
// 			{
// 				//PAout(0) = ~PAout(0);
// 				PAout(0) = 0;
// 			}
