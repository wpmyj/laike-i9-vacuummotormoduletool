...
typedef struct _ST_WORK_MANAGER{
	...
	u8 mWorkKey1PressFlag : 1;
	u8 mWorkKey1PressFlag1 : 1;
	u8 mWorkKey1Cont;
	...
	u8 mWorkVacuumPWMFlag;   //1:40WPWM输出   2:60WPWM输出
	u8 mWorkVacuumFirst : 1;
	
	u8 mWorkVacuumPWMSendFlag : 2;
	u8 mWorkVacuumPWMSendCont;
}_ST_WORK_MANAGER;
